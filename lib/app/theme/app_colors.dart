...
class AppColors {
  ...
  // --- Gradients (static final) ---
  static final LinearGradient lostGradient = const LinearGradient(
    begin: Alignment.topLeft, end: Alignment.bottomRight,
    colors: [Color(0xFFE53935), Color(0xFFD32F2F)],
  );

  static final LinearGradient foundGradient = const LinearGradient(
    begin: Alignment.topLeft, end: Alignment.bottomRight,
  ...
  static final LinearGradient secondaryGradient = const LinearGradient(
    begin: Alignment.topLeft, end: Alignment.bottomRight,
    colors: [Color(0xFFFF6584), Color(0xFFFF8BA0)],
  );

  static final LinearGradient accentGradient = const LinearGradient(
    begin: Alignment.topLeft, end: Alignment.bottomRight,
  ...
  static final LinearGradient onboarding1Gradient = LinearGradient(
    begin: Alignment.topLeft, end: Alignment.bottomRight,
    colors: [onboarding1Primary, onboarding1Secondary],
  );

  static final LinearGradient onboarding2Gradient = LinearGradient(
    begin: Alignment.topLeft, end: Alignment.bottomRight,
    colors: [onboarding2Primary, onboarding2Secondary],
  );

  static final LinearGradient onboarding3Gradient = LinearGradient(
    begin: Alignment.topLeft, end: Alignment.bottomRight,
  ...
  // --- Shadows (static final) ---
  static final List<BoxShadow> cardShadow = [
    const BoxShadow(color: Color(0x146C63FF), blurRadius: 24, offset: Offset(0, 8)),
  ];

  static final List<BoxShadow> buttonShadow = [
    const BoxShadow(color: Color(0x406C63FF), blurRadius: 16, offset: Offset(0, 4)),
  ];
  ...
  static final List<BoxShadow> elevatedShadow = [
    const BoxShadow(color: black20, blurRadius: 30, offset: Offset(0, 15)),
    const BoxShadow(color: white30, blurRadius: 20, offset: Offset(0, 5)),
  ];

  static final List<BoxShadow> darkCardShadow = [
    const BoxShadow(color: Color(0x26000000), blurRadius: 24, offset: Offset(0, 8)),
  ];

  static final List<BoxShadow> darkSoftShadow = [
