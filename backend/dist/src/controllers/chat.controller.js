...
const TOPICS = [
    ...
    },
    {
        ...
        answer: 'CivicConnect has 5 bottom tabs:\n\n' +
            '1. Home\n' +
            '• Greets you by name\n' +
    ...
    },
    {
        ...
        answer: 'Complete guide to using CivicConnect:\n\n' +
            '1. Create an account\n' +
    ...
    },
    {
        ...
        answer: 'How to report an issue in CivicConnect (full steps):\n\n' +
    ...
    },
    {
        ...
        answer: 'Home is your CivicConnect overview. It includes:\n\n' +
    ...
    },
    {
        ...
        answer: 'The Reports tab shows apartment issues in detail:\n\n' +
            '• Full list of building reports\n' +
    ...
    },
    {
        ...
        answer: 'CivicConnect report statuses:\n\n' +
            '• Pending — submitted and waiting\n' +
    ...
    },
    {
        ...
        answer: 'CivicConnect categories (choose one when submitting):\n\n' +
    ...
    },
    {
        ...
        answer: 'Profile is your personal CivicConnect area:\n\n' +
    ...
    },
    {
        ...
        answer: 'Accounts in CivicConnect:\n\n' +
            'Sign Up:\n' +
    ...
    },
    {
        ...
        answer: 'Ask AI is CivicConnect’s in-app guide. I explain:\n\n' +
...
function buildReply(message) {
    ...
    if (/who (are|r) you|what (can|do) you (do|help)|help me\b/.test(text)) {
        return ('I’m the CivicConnect assistant. I answer completely about how this app works.\n\n' +
            APP_OVERVIEW +
            '\n\nAsk any follow-up and I’ll include all related steps and details.');
    }
    const matched = TOPICS.filter((topic) => topic.patterns.some((pattern) => pattern.test(text)));
    if (matched.length === 0) {
...
class ChatController {
    chat = async (req, res, next) => {
        try {
            const { message, history } = chat_dto_1.ChatMessageSchema.parse(req.body);
            let reply = null;
            try {
            ...
            (0, apihelper_util_1.sendResponse)(res, 200, true, 'Assistant reply generated', {
                reply,
